...
function Screen(width, height) {
	...
	document.getElementById("Space").appendChild(this.canvas)
}
...
$(document).on("page:change", function () {
	...
	function main() {
		...
		alien.addEventListener("load", function () {
			adSprites = [[new Sprite(alien, 0, 0, 150, 75)], [new Sprite(alien, 170, 0, 150, 75)], [new Sprite(alien, 0, 110, 150, 75)]];
	...
	function run() {
		var paintScene = function paintScene() {
			...
			if (isGameOver === true) {
				...
				setTimeout(afterExplosion, 3000);
				return;
			}
